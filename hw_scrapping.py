...
def find_vacancies(url, params):
    ...
    if response.status_code == 200:
        ...
        for vacancy_item in vacancy_items:
            ...
            city, metros = find_city_and_metro(address_text, soup)
...
def find_city_and_metro(address_text, soup):
    city = ""
    metros = []
...
if __name__ == "__main__":
    ...
    vacancies = find_vacancies(url, params)

    print("Finded vacancies:", vacancies)

    with open('vacancies.json', 'w', encoding='utf-8') as file:
        json.dump(vacancies, file, indent=2, ensure_ascii=False)

    print("Succesfully saved to vacancies.json.")
